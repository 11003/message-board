...
{
$res=$conn->query("insert into art (title,clim_ide,zuoz,fbsj,img,matter) values ('".$_POST['title']."','".$_POST['clim_ide']."','".$_POST['zuoz']."','".$_POST['fbsj']."','".$_POST['img']."','".$_POST['matter']."')");
if($res)
{
	echo "<script>alert('添加成功');location.href='art_list.php'</script>";
}
else
{
